...
function RecipeContent() {
  ...
  // Fetch recipe whenever recipeName parameter changes
  useEffect(() => {
    if (recipeName) {
      const normalizedQuery = recipeName.trim().toLowerCase();
      const currentTitle = recipe?.title?.trim()?.toLowerCase();

      if (!currentTitle || currentTitle !== normalizedQuery) {
        setRecipe(null);
        ...
        <div className="mb-8">
          ...
          <div className="bg-white p-8 md:p-10 border-2 border-stone-200 mb-6">
            <div className="grid lg:grid-cols-12 gap-8 items-start">
              {/* Left Side: Heading, Description & Details */}
              <div className="lg:col-span-7 flex flex-col justify-between">
                <div>
                  ...
                  {/* Description */}
                  <p className="text-base md:text-lg text-stone-600 mb-6 font-light leading-relaxed">
                    {recipe.description}
                  </p>
              ...
              {/* Right Side: Recipe Picture */}
              <div className="lg:col-span-5 w-full">
                <div className="relative w-full aspect-4/3 lg:aspect-square overflow-hidden border-2 border-stone-900 shadow-md group bg-stone-100">
                  <Image
                    src={
                      recipe.imageUrl ||
